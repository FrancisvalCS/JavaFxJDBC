...
import gui.uil.Alerts;
import gui.uil.Constrants;
import gui.uil.Utils;
...
public class SellerFormController implements Initializable {
	...
	public void setServices(SellerService service, DepartmentServices departmentService) {
	...
	private void initializeNodes() {
		...
		Constrants.setTextFieldMaxLength(txtName, 70);
		Constrants.setTextFieldDouble(txtBaseSalary);
		Constrants.setTextFieldMaxLength(txtEmail, 60);
	...
	private void setErrorMessages(Map<String, String> error) {
		...
		labelErrorBaseSalary.setText((fields.contains("birthDate") ? error.get("birthDate") : ""));
		labelErrorBithDate.setText((fields.contains("baseSalary") ? error.get("baseSalary") : ""));
